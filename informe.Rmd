...
\begin{itemize}
  ...
  \item{Analizar la evaluación entre el ritmo musical (BPM) y el nivel de insomnio declarado, empleando diagramas de dispersión, para evaluar la existencia de una relación entre ritmos acelerados y dificultades del sueño.}
